...
import { authGuard } from './application/core/authentication';
        ...
        RouterModule.forRoot([
...

            {
                ...
                children: [
                    ...
                    { path: 'examination', loadChildren: () => import('./application/modules/examination/examination.module').then(m => m.ExaminationModule) }
                ]
            },

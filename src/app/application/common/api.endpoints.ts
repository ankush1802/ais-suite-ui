...
export enum ApiBaseUrls {
    authbaseUrl = 'https://localhost/auth-management/',
    entitybaseUrl = 'https://localhost/entity-management/',
    rolebaseUrl = 'https://localhost/role-management/',
    userbaseUrl = 'https://localhost/user-management/',
  }
